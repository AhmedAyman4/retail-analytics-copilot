...
# 2. Planner: Extracts constraints for hybrid/sql queries
...
class SynthesizerSignature(dspy.Signature):
    """
    Answer the user question based on SQL results and/or Context.
    Ensure output matches the format_hint exactly.
    """
    question = dspy.InputField()
    context = dspy.InputField(desc="Retrieved text chunks")
